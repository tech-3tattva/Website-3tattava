...
const SUGGESTIONS: Suggestion[] = [
  ...
  { label: 'Performance Ayurveda', route: '/products', type: 'category' },
  { label: 'Fulvic Acid Supplement', route: '/products/shodhit-shilajit-resin', type: 'category' },
  { label: 'Ayurvedic Minerals', route: '/products', type: 'category' },
  ...
  { label: 'All Products', route: '/products', type: 'category' },
