  ...
  return (
    <section className="w-full bg-beige-dark py-16 md:py-20 px-6 relative overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 5 L35 25 L55 30 L35 35 L30 55 L25 35 L5 30 L25 25 Z' fill='%235c4033'/%3E%3C/svg%3E")`,
        }}
      />
