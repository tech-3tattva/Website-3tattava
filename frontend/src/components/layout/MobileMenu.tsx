      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed left-0 top-0 bottom-0 w-[min(320px,85vw)] max-h-[100dvh] bg-[#1A1A1A] z-50 tablet:hidden flex flex-col pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]"
          >
