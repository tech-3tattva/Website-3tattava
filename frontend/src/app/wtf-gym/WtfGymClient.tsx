...
/* FAQ — dark */
.wg-faq-sec{background:radial-gradient(70% 55% at 50% 46%,rgba(12,12,12,0.34),rgba(12,12,12,0) 78%),url('/wtf/faq-bg.webp') center/contain no-repeat,${DARK};padding:clamp(56px,9vw,100px) 24px;color:#fff;}
