...
export const shahjeetSticks: ProductData = {
  ...
  faqs: [
    ...
    { q: 'Are Shahjeet Sticks suitable for women?', a: 'Yes. SHAHJEET STICKS are designed for both men and women seeking daily strength, energy and mineral support. They are particularly beneficial for women experiencing iron deficiency or low energy. Not recommended during pregnancy or breastfeeding without medical advice.' },
    { q: 'What makes Shahjeet Sticks different from other Shilajit honey sticks in India?', a: 'SHAHJEET STICKS contain 600mg of Shilajit per stick — the highest dose available in this format. We use raw Himalayan honey (not processed) as the Anupana. Every batch is third-party tested by an NABL-accredited laboratory, with results published. No artificial preservatives, no added sugars, no fillers.' },
    { q: 'Where are Shahjeet Sticks manufactured?', a: 'SHAHJEET STICKS are manufactured in an AYUSH-GMP certified facility in Rajasthan. They are marketed by SankalpaSiddhi Ayupharma Pvt. Ltd., Shahdara, Delhi. Lab testing is conducted at an NABL-accredited third-party laboratory.' },
  ],
  comparisonRows: [
