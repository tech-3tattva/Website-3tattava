...
export const shahjeetSticks: ProductData = {
  ...
  faqs: [
    ...
    { q: 'Where are Shahjeet Sticks manufactured?', a: 'SHAHJEET STICKS are manufactured by URMI Lifesciences LLP in an AYUSH-GMP certified facility in Rajasthan. They are marketed by SankalpaSiddhi Ayupharma Pvt. Ltd., Shahdara, Delhi. Lab testing is conducted at an NABL-accredited third-party laboratory.' },
  ],
  comparisonRows: [
