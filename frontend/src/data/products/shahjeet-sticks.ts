...
export const shahjeetSticks: ProductData = {
  ...
  faqs: [
    ...
    { q: 'Are Shahjeet Sticks suitable for diabetics?', a: 'Each stick contains 7.4g of natural honey with approximately 6g carbohydrates. If you are diabetic or monitoring blood sugar, consult your physician before use. This product is not intended to treat or manage any medical condition.' },
