...
export const shahjeetSticks: ProductData = {
  ...
  faqs: [
    ...
    { q: 'Are Shahjeet Sticks suitable for diabetics?', a: 'Each stick contains 7.4g of natural honey with approximately 6g carbohydrates. Shahjeet is an Ayurvedic proprietary medicine (Mfg. Lic. RJ-926AYU); use as directed on the pack. If you are managing diabetes or any medical condition, consult your physician before use.' },
    ...
    { q: 'Where are Shahjeet Sticks manufactured?', a: 'SHAHJEET STICKS are manufactured by URMILIFE SCIENCES LLP under Ayurveda licence RJ-926AYU at an AYUSH-GMP certified facility, and marketed by SankalpaSiddhi Ayupharma Pvt. Ltd., New Seemapuri, Delhi. Lab testing is conducted at an NABL-accredited third-party laboratory.' },
  ],
  comparisonRows: [
