...
export const shodhitShilajitResin: ProductData = {
  ...
  faqs: [
    ...
    { q: 'What is the Triphala Shodhan purification method?', a: 'Shodhan is the classical Ayurvedic purification process prescribed in texts like Ashtanga Hridayam. We use Triphala-infused water to purify the raw resin, removing all sand, heavy metals and impurities while enhancing bioavailability and therapeutic strength. The process is conducted by URMI Lifesciences LLP under AYUSH-GMP conditions.' },
    ...
    { q: 'Where is SHODHIT SHILAJIT RESIN sourced and manufactured?', a: 'The raw Shilajit is sourced from Himalayan deposits at 10,000-16,000ft altitude (Asphaltum Punjabanum). It is purified and manufactured by URMI Lifesciences LLP (Mfg. Lic. No. RJ-926AYU E) in Rajasthan, an AYUSH-GMP certified facility. It is marketed by SankalpaSiddhi Ayupharma Pvt. Ltd., Delhi.' },
  ],
  comparisonRows: [
