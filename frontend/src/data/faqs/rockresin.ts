...
export const ROCKRESIN_FAQS: FAQItem[] = [
  ...
  { id: 4, question: "Is it for men or women?", answer: "Both. Classical Ayurvedic texts recommend Shilajit as a Rasayana for men and women alike \u2014 for everyday energy, mineral balance and healthy ageing. If you are pregnant or breastfeeding, it is best to check with your doctor before use." },
