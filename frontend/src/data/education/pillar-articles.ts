...
export const PILLAR_ARTICLES: BlogArticle[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Shilajit is used most by adults looking for support with energy, recovery, training and general vitality. Because the strongest human trials are in specific groups (older men for testosterone; oligospermic men for fertility; recreationally active men for strength), benefits should not be over-generalised — a healthy 22-year-old is not the population most of these studies used.\n\nIt should be **avoided or used only under medical guidance** by some people. Do not use in pregnancy or breastfeeding (inadequate safety data). Take medical advice if you have haemochromatosis or iron overload (Shilajit contains iron), if you take medication, or if you have a chronic condition. See the full [Shilajit safety guide](/education/shilajit-safety).`,
      },
      {
    ...
    takeaways: [
      ...
      "Modern evidence is genuine but modest: strongest for testosterone in older men and strength retention; weak or absent for claims like cognition.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Partly. Small human trials support benefits like testosterone in older men and strength retention, and reviews describe antioxidant and anti-fatigue effects. Other claims — cognition especially — rest on lab work only, with no human trials yet.",
      },
      {
