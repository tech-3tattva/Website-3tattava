...
// Dummy doctors for pre-launch (replace with API call)
...
export default function VaidyaConnectPage() {
  ...
  const handleSearch = (city: string) => {
    ...
    setTimeout(() => {
      setDoctors(DUMMY_DOCTORS); // In production: fetch(`/api/doctors?city=${city}`)
      setSearched(true);
      setOrbPhase('done');
    }, 1200);
  };
  ...
  return (
    <>
      <style>{`
        ...
        /* Doctor silhouette SVG inside orb */
        .vc-orb-icon {
