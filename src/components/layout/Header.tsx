      ...
      <header className="sticky top-0 z-30 bg-white">
        ...
        >
          ...
          <div className="absolute left-1/2 -translate-x-1/2 hidden tablet:block">
            <Logo className="[&_span]:text-white [&_.font-devanagari]:text-gold" />
          </div>
        ...
        {/* Tier 2 — Main Navigation (slides up on scroll down; fixed height = no layout shift) */}
        <div
          className="overflow-hidden border-b border-border bg-white transition-transform duration-300 ease-out"
          style={{
        ...
        >
          <nav
            className="h-[52px] flex items-center justify-center gap-6 md:gap-8 px-4"
            style={{
